...
bedtools subtract -b At_upstream.gff3 -a At_downstream.gff3 > At_downstream_subtracted.gff3
bedtools subtract -b At_cds.gff3 -a At_downstream_subtracted.gff3 > At_downstream_subtracted2.gff3
cat At_genes.gff3 At_upstream.gff3 At_downstream_subtracted2.gff3 | sortBed > At_combined.gff3
...
bedtools coverage -s -counts -a AtPEATtss.bed -b At_downstream_subtracted2.gff3 > AtPEAT_downstream.coverage
...
bedtools coverage -s -counts -a $AtOligo_bed -b At_downstream_subtracted2.gff3 > AtOligo_downstream.coverage
...
bedtools coverage -s -counts -a AtCAGEtss.bed -b At_downstream_subtracted2.gff3 > AtCAGE_downstream.coverage
...
bedtools coverage -s -counts -a AtPEATtss_t.bed -b At_downstream_subtracted2.gff3 > AtPEAT_t_downstream.coverage
...
bedtools coverage -s -counts -a AtOligotss_t.bed -b At_downstream_subtracted2.gff3 > AtOligo_t_downstream.coverage
...
bedtools coverage -s -counts -a AtCAGEtss_t.bed -b At_downstream_subtracted2.gff3 > AtCAGE_t_downstream.coverage
