...
bedtools coverage -s -counts -a $AtPEAT -b At_downstream_subtracted2.gff3 > AtPEAT_downstream.tsr
...
bedtools coverage -s -counts -a $AtOligo -b At_downstream_subtracted2.gff3 > AtOligo_downstream.tsr
...
bedtools coverage -s -counts -a $AtCAGE -b At_downstream_subtracted2.gff3 > AtCAGE_downstream.tsr
